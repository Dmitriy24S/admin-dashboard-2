...
const SidebarContent = () => {
  ...
  const activeLink =
    'flex items-center gap-4 pl-4 pt-3 pb-2.5 rounded-lg bg-light-gray text-md m-2 dark:text-gray-700'
  const normalLink =
  ...
  return (
    <div className='px-3 h-screen overflow-auto overscroll-contain pb-10'>
      {isSidebarOpen && (
        <>
